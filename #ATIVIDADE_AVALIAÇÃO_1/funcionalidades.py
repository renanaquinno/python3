...
def total(dados):
    print(cabecalho('Total de Coligacoes'),
          "Coligações: {}".format(len(dados)))


def lista_todos_coligacoes(dados):
    for registro in dados:
        print(registro['coligacoes'])

def lista_todos_vereadores(dados):
    for registro in dados:
        print(registro)
